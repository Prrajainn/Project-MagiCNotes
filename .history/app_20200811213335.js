...
function showNotes() {
    ...
    html += `
            <div class="noteCard my-2 mx-2 card" style="width: 18rem;">
                    <div class="card-body">
                        ...
                        <button id="${index}"onclick="deleteNote(this.id)" class="btn btn-">Delete Note</button>
                    </div>
                </div>`;
  });
  ...
  } else {//notesElm.setAttribute('style','color: blue' );
  notesElm.setAttribute('style','font-size: 200% ; color: blue' );
